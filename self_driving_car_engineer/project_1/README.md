...
The files are be downloaded directly from the website as tar files or from the [Google Cloud Bucket](https://console.cloud.google.com/storage/browser/waymo_open_dataset_v_1_2_0_individual_files/) as individual tf records.
...
In the class, we talked about cross-validation and the importance of creating meaningful training and validation splits. For this project, you will have to create your own training and validation sets using the files located in `/app/project/data/waymo`. The `split` function in the `create_splits.py` file does the following:
...
```
python create_splits.py --data-dir /app/project/data
```
